<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="PendingFollowupDetails.aspx.cs" Inherits="OrthoSquare.Enquiry.PendingFollowupDetails" %>
   ...
   <asp:Panel ID="AddPane" Visible="false" runat="server">
        ...
        <div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<span>PENDING FOLLOWUP DETAILS </span>
				</li>
			</ul>
                ...
                <div class="portlet light ">
					<div class="portlet-title">
						<div class="caption font-red-sunglo">
							...
							<span class="caption-subject bold uppercase">PENDING FOLLOWUP DETAILS</span>
						</div>
                        </div>
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-red sbold uppercase">PENDING FOLLOWUP DETAILS</span>
						</div>
						<%--<div class="actions">
                                ...
                                <asp:TemplateField HeaderText="Action" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton ID="ImageButton1" runat="server" ToolTip="Add To Patient" CausesValidation="false"
                                           ...
                                           <asp:ImageButton ID="btnview" CausesValidation="false" Visible ="false" runat="server" Width="30px" CommandArgument='<%# Eval("EnquiryID") %>'
