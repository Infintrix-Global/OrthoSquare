                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">Enquiry Source</span>
                        </div>
                       <%-- <div class="actions">
                            <div class="btn-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtAdd" class="form-control"
                                         ...
                                         <asp:RequiredFieldValidator ID="RequiredtxtAdd" runat="server" ControlToValidate="txtAdd"
                                                    SetFocusOnError="true" ErrorMessage="Please Enter Enquiry Source Name" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </span>
                                    </div>
