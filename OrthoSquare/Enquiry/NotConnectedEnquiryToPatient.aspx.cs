...
{
    public partial class NotConnectedEnquiryToPatient : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                txtSFromFollowDate.Text = Convert.ToDateTime(System.DateTime.Now).AddDays(-30).ToString("dd-MM-yyyy");
        ...
        public void getEnquiryFollowPuReport()
        {
            ...
            AllData = objExp.GetEnquiryFollowPuReport(txtSFromFollowDate.Text, txtSToFollowDate.Text, Convert.ToInt32(ddlClinic.SelectedValue), Convert.ToInt32(DoctorId), "2");
