...
namespace OrthoSquare.Enquiry
{
    public partial class FollowUpReport : System.Web.UI.Page
    {
        ...
        public void getEnquiryFollowPuReport()
        {
            ...
            AllData = objExp.GetEnquiryFollowPuReport(txtSFromFollowDate.Text, txtSToFollowDate.Text, Convert.ToInt32(ddlClinic.SelectedValue), Convert.ToInt32(DoctorId), "3");
