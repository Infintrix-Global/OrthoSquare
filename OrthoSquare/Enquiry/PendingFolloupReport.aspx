<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="PendingFolloupReport.aspx.cs" Inherits="OrthoSquare.Enquiry.PendingFolloupReport" %>
                ...
                <div id="Div1" runat="server" class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span> Pending Follow up Report</span>
                            </li>
                        </ul>
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Pending Follow up Report</span>
                                    </div>
                                            ...
                                            <div class="table-scrollable">
                                                ...
                                                <asp:GridView ID="gvShow" runat="server" AllowPaging="true" AutoGenerateColumns="false" ShowFooter="true"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Folllowup Date">
                                                            <ItemTemplate>
