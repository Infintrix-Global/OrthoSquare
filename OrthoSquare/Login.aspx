...
<head runat="server">
    ...
    <body class=" login">
        ...
        <!-- BEGIN LOGIN -->
        <div class="content">
        <div class="col-md-6"><div class="quote-txt border-right"><img src="../assets/pages/img/login/quotes.png" alt=""/></div></div>
        <div class="col-md-6">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="http://keenthemes.com/preview/metronic/theme/admin_2/index.html" method="post">
               <div class="logo"><img src="../assets/pages/img/login/l-login.png" width="169" height="103" alt=""/></div>
        ...
        <div class="copyright"> &copy; 2018 All Rights Reserved</a> &nbsp;|&nbsp;
                <a href="www.infintrixglobal.com" title="">Designed by InfintrixGlobal</a> </div>
        <!--[if lt IE 9]>
