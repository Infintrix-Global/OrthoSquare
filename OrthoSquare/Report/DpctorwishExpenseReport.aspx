<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="DpctorwishExpenseReport.aspx.cs" Inherits="OrthoSquare.Report.DpctorwishExpenseReport" %>
     ...
     <asp:Panel ID="Edit" runat="server">
        ...
        <div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<span>Doctor Expense Report</span>
				</li>
			</ul>
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-red sbold uppercase">Doctor Expense Report</span>
						</div>
						<%--<div class="actions">
