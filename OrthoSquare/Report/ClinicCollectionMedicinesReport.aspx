<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="ClinicCollectionMedicinesReport.aspx.cs" Inherits="OrthoSquare.Report.ClinicCollectionMedicinesReport" %>
        ...
        <div id="Div1" runat="server" class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Clinic Medicines Collection Report</span>
                    </li>
                </ul>
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red sbold uppercase">Clinic Medicines Collection Report</span>
                            </div>
                            <%--<div class="actions">
