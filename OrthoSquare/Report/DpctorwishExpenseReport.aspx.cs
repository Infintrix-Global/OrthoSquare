...
{
    public partial class DpctorwishExpenseReport : System.Web.UI.Page
    {
        ...
        public void getAllExpense()
        {
            ...
            AllData = objExp.GetAllDoctorExpenSeReport(Convert.ToInt32(SessionUtilities.Empid), txtSFromFollowDate.Text, txtSToFollowDate.Text);
