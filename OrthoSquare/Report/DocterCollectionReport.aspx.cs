...
namespace OrthoSquare.Report
{
    public partial class DocterCollectionReport : System.Web.UI.Page
    {
        ...
        public void getAllCollection()
        {
            ...
            AllData = objExp.GetAllDocterCollectionReport(Convert.ToInt32(ddlClinic.SelectedValue), Convert.ToInt32(ddlDocter.SelectedValue));
        ...
        protected void gvShow_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lblPendingAmount.Text = objExp.GetPendingAmount(Convert.ToInt32(lblClinicID.Text),(Convert.ToInt32(lblDoctor.Text)),0).ToString();
