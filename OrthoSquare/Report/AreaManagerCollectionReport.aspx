<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="AreaManagerCollectionReport.aspx.cs" Inherits="OrthoSquare.Report.AreaManagerCollectionReport" %>
        ...
        <div id="Div1" runat="server" class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Area Manager Collection Report</span>
                    </li>
                </ul>
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red sbold uppercase">Area Manager Collection Report</span>
                            </div>
                            <%--<div class="actions">
