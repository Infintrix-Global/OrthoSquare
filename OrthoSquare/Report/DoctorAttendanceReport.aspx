<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="DoctorAttendanceReport.aspx.cs" Inherits="OrthoSquare.Report.DoctorAttendanceReport" %>
    ...
    <asp:Panel ID="Edit" runat="server">
        ...
        <div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<span>Doctor Attendance Report </span>
				</li>
			</ul>
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-red sbold uppercase">Doctor Attendance Report </span>
						</div>
						<%--<div class="actions">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="table-scrollable">
                                  ...
                                  <asp:GridView ID="GridDocterAttendance" runat="server" AllowPaging="true" AutoGenerateColumns="false"     OnPageIndexChanging="gvAttendance_PageIndexChanging"
									class="table table-bordered table-hover" >
										...
										<asp:TemplateField HeaderText="Doctor Name" ItemStyle-Width="10%">
										  ...
										  <asp:TemplateField HeaderText="Date" ItemStyle-Width="18%">
											<ItemTemplate>
											<asp:Label ID="lblEnqDate" runat="server" Text='<%# Eval("AttendanceDate","{0:dd/MM/yyyy}") %>'></asp:Label>
											</ItemTemplate>
									     	</asp:TemplateField>
										
										<asp:TemplateField HeaderText="In Time" ItemStyle-Width="18%">
											<ItemTemplate>
												<asp:Label ID="lblPaidAmount" runat="server"  Text='<%# Eval("TimeIn","{0:HH mm tt}") %>'></asp:Label>
											</ItemTemplate>
                                           ...
                                           <asp:TemplateField HeaderText="Out Time" ItemStyle-Width="18%">
											<ItemTemplate>
												<asp:Label ID="lblPaidAmount" runat="server"  Text='<%# Eval("TimeOut","{0:HH mm tt}") %>'></asp:Label>
											</ItemTemplate>
