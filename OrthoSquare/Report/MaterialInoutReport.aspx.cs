...
{
    public partial class MaterialInoutReport : System.Web.UI.Page
    {
        ...
        public void getAllCollection()
        {
            ...
            AllData = objM.GetAllDocterinoutMaterialReport(Convert.ToInt32(ddlClinic.SelectedValue), Convert.ToInt32(ddlDocter.SelectedValue));
