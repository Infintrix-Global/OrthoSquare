<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="ViewClinicwishExpenseReport.aspx.cs" Inherits="OrthoSquare.Report.ViewClinicwishExpenseReport" %>
     ...
     <asp:Panel ID="Edit" runat="server">
        ...
        <div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<span>Clinic Expense Report</span>
				</li>
			</ul>
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-red sbold uppercase">Clinic Expense Report</span>
						</div>
						<%--<div class="actions">
							 ...
							 <asp:GridView ID="gvShow" runat="server" AllowPaging="true" AutoGenerateColumns="false"  ShowFooter ="true" 
                                ...
                                <Columns>
                                 ...
                                 <asp:TemplateField HeaderText="Clinic Name" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblDname" runat="server" Text='<%# Eval("ClinicName")%>'></asp:Label>
                                        </ItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="Vendor Name" >
                                      ...
                                      <asp:TemplateField HeaderText="Date" >
                                        <ItemTemplate>
                                             <asp:Label ID="lblstart_date" runat="server" Text='<%# Eval("ExpDate","{0:dd/MMM/yyyy}") %>'></asp:Label>
