...
{
    public partial class AreaManagerReport : System.Web.UI.Page
    {
        ...
        public void getAllAreaManager()
        {

            AllData = objExp.GetAreaManagerReport(Convert.ToInt32(DoctorID));

         
            if (AllData != null && AllData.Rows.Count > 0)
            {

                lblTotalTop.Text = AllData.Rows.Count.ToString();
        ...
        protected void gvShow_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                DataTable dt = objG.GetDataTable("GET_AreaManagerReport", nv);
