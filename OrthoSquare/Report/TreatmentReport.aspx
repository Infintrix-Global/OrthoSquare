                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">Treatments Report</span>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="table-scrollable">
                                    ...
                                    <asp:GridView ID="gvShow" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                                        class="table table-bordered table-hover" OnRowDataBound="gvShow_RowDataBound" ShowHeaderWhenEmpty="true"
