<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="ManageMaterialStock.aspx.cs" Inherits="OrthoSquare.Master.ManageMaterialStock" %>
    ...
    <asp:Panel ID="Edit" runat="server">
        ...
        <div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<span>Order History Material</span>
				</li>
			</ul>
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-red sbold uppercase">Order History Material</span>
						</div>
						<%--<div class="actions">
