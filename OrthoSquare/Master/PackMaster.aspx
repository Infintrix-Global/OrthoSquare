<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="PackMaster.aspx.cs" Inherits="OrthoSquare.Master.PackMaster" %>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-scrollable">
                            ...
                            <asp:GridView ID="gvShow" runat="server" class="table table-bordered table-hover"
                                    GridLines="None" DataKeyNames="PackId" AutoGenerateColumns="false" OnRowUpdating="gvShow_RowUpdating"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="60%" HeaderText="Pack Name">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("PackName") %>' class="form-control input-sm"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
