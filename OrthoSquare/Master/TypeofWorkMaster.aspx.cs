...
{
    public partial class TypeofWorkMaster : System.Web.UI.Page
    {
        BAL_TypeOfWork objTofW = new BAL_TypeOfWork();
        ...
        public void getAllTypeOfWork()
        {

            AllData = objTofW.GetAllTypeWork();
        ...
        protected void btAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _isInserted = objTofW.AddWorkType(txtAdd.Text);

                if (_isInserted == -1)
                {
                    lblMessage.Text = "Failed to Add  Type Of Work";
                    lblMessage.ForeColor = System.Drawing.Color.Red;
                }
                else
                {

                    lblMessage.Text = "Type Of Work Added Successfully";
        ...
        protected void btSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtSearch.Text != "")
                {
                    search += "TypeName like '%" + txtSearch.Text + "%'";
        ...
        protected void gvShow_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                int _isDeleted =objTofW.DeleteTypeWOrk(ID);
                if (_isDeleted != -1)
                {
                    DataTable UserLog = (DataTable)Session["User"];

                    lblMessage.Text = "Type Of Work Deleted.";
                    lblMessage.ForeColor = System.Drawing.Color.Red;
                    Response.Redirect("TypeofWorkMaster.aspx");
                    btSearch_Click(sender, e);
                }
            }
            catch (Exception ex)
        ...
        protected void gvShow_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            isUpdated = objTofW.UpdateTypeWork(txtName.Text, Convert.ToInt32(lblID.Text));
            if (isUpdated == 1)
            {
                // DataTable UserLog = (DataTable)Session["User"];

                lblMessage.Text = "Type Of Work Updated Successfully";
                lblMessage.ForeColor = System.Drawing.Color.Green;
                //gvShow.EditIndex = -1;
                //  getAllCategoryGrid();
                Response.Redirect("TypeofWorkMaster.aspx");
            ...
            {
                lblMessage.Text = "Failed to Update Type Of Work";
                lblMessage.ForeColor = System.Drawing.Color.Red;
            }
        }
