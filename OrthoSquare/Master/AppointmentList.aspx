<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="AppointmentList.aspx.cs" Inherits="OrthoSquare.Master.AppointmentList" %>
    ...
    <div id="Edit" runat="server" class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<span>Today Appointment List</span>
				</li>
			</ul>
				...
				<div class="portlet light ">
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject font-red sbold uppercase">Today Appointment List</span>
						</div>
						<%--<div class="actions">
