                       ...
                       <div class="text-right mb-20">
                        ...
                        <div class="table-scrollable">
                            ...
                            <asp:GridView ID="gvShow" runat="server" class="table table-bordered table-hover"
                                    GridLines="None" DataKeyNames="UnitId" AutoGenerateColumns="false" OnRowUpdating="gvShow_RowUpdating"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="60%" HeaderText="Unit Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblName" runat="server" Text='<%# Eval("UnitName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("UnitName") %>' class="form-control input-sm"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
