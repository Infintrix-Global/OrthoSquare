<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="DentalCategory.aspx.cs" Inherits="OrthoSquare.Master.DentalCategory" %>
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">Dental Category</span>
                        </div>
                       <%-- <div class="actions">
                            <div class="btn-group">
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">Dental Category</span>
                        </div>
                       ...
                       <div class="text-right mb-20">
                        ...
                        <div class="table-scrollable">
                            ...
                            <asp:GridView ID="gvShow" runat="server" class="table table-bordered table-hover"
                                    GridLines="None" DataKeyNames="CategoryID" AutoGenerateColumns="false" OnRowUpdating="gvShow_RowUpdating"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="60%" HeaderText="Category Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblName" runat="server" Text='<%# Eval("CategoryName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("CategoryName") %>' class="form-control input-sm"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="lbtDelete" runat="server" CommandName="delete" ImageUrl="../Images/delete15x15.png"
                                                    CausesValidation="False" OnClientClick="return confirm('Are you sure you want to delete this Category Name?');" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
