                        ...
                        <div class="table-scrollable">
                            ...
                            <asp:GridView ID="gvShow" runat="server" class="table table-bordered table-hover"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="60%" HeaderText="Vendor Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblName" runat="server" Text='<%# Eval("VendorName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("VendorName") %>' class="form-control input-sm"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
