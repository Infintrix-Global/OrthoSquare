<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="VendorType.aspx.cs" Inherits="OrthoSquare.Master.VendorType" %>
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">Vendor Type</span>
                        </div>
                       <%-- <div class="actions">
                            <div class="btn-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtAdd" class="form-control"
                                         ...
                                         <asp:RequiredFieldValidator ID="RequiredtxtAdd" runat="server" ControlToValidate="txtAdd"
                                                    SetFocusOnError="true" ErrorMessage="Please Enter Vendor Type" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </span>
                                    </div>
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">Vendor Type</span>
                        </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-scrollable">
                            ...
                            <asp:GridView ID="gvShow" runat="server" class="table table-bordered table-hover"
                                    GridLines="None" DataKeyNames="VendorTypeId" AutoGenerateColumns="false" OnRowUpdating="gvShow_RowUpdating"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="30%" HeaderText="Sr. No.">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("VendorTypeId") %>' Visible="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-Width="60%" HeaderText="Vendor Type">
                                            <ItemTemplate>
                                                <asp:Label ID="lblName" runat="server" Text='<%# Eval("VendorType") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("VendorType") %>' class="form-control input-sm"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="lbtDelete" runat="server" CommandName="delete" ImageUrl="../Images/delete15x15.png"
                                                    CausesValidation="False" OnClientClick="return confirm('Are you sure you want to delete this Vendor Type?');" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
