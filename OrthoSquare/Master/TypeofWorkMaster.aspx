<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="TypeofWorkMaster.aspx.cs" Inherits="OrthoSquare.Master.TypeofWorkMaster" %>
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">Type Of Work (Leb)</span>
                        </div>
                       <%-- <div class="actions">
                            <div class="btn-group">
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">Type Of Work (Lab)</span>
                        </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-scrollable">
                            ...
                            <asp:GridView ID="gvShow" runat="server" class="table table-bordered table-hover"
                                    GridLines="None" DataKeyNames="TypeOfworkId" AutoGenerateColumns="false" OnRowUpdating="gvShow_RowUpdating"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="30%" HeaderText="Sr. No.">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("TypeOfworkId") %>' Visible="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-Width="60%" HeaderText="Name">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("TypeName") %>' class="form-control input-sm"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="lbtDelete" runat="server" CommandName="delete" ImageUrl="../Images/delete15x15.png"
                                                    CausesValidation="False" OnClientClick="return confirm('Are you sure you want to delete this Type of Work?');" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
