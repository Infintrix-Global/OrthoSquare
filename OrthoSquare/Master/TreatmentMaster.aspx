<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="TreatmentMaster.aspx.cs" Inherits="OrthoSquare.Master.TreatmentMaster" %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="help-block">
                                         <asp:RequiredFieldValidator ID="RequiredtxtAdd" runat="server" ControlToValidate="txtAdd"
                                                    SetFocusOnError="true" ErrorMessage="Please Enter Treatment Name" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </span>
                                    </div>
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">Treatment</span>
                        </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-scrollable">
                            ...
                            <asp:GridView ID="gvShow" runat="server" class="table table-bordered table-hover"
                                    GridLines="None" DataKeyNames="TreatmentID" AutoGenerateColumns="false" OnRowUpdating="gvShow_RowUpdating"
                                        ...
                                        <asp:TemplateField ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="lbtDelete" runat="server" CommandName="delete" ImageUrl="../Images/delete15x15.png"
                                                    CausesValidation="False" OnClientClick="return confirm('Are you sure you want to delete this Treatment Name?');" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
