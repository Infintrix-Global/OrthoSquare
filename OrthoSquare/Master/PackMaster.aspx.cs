...
{
    public partial class PackMaster : System.Web.UI.Page
    {
        ...
        public void getAllPack()
        {

            AllData = objPack.GetAllPack();
        ...
        protected void btAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _isInserted = objPack.AddPack(txtAdd.Text);
        ...
        protected void btSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtSearch.Text != "")
                {
                    search += "PackName like '%" + txtSearch.Text + "%'";
        ...
        protected void gvShow_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                int _isDeleted = objPack.DeletePack(ID);
                if (_isDeleted != -1)
                {
                    DataTable UserLog = (DataTable)Session["User"];

                    lblMessage.Text = "Pack Deleted.";
                    lblMessage.ForeColor = System.Drawing.Color.Red;
                    Response.Redirect("PackMaster.aspx");
                    btSearch_Click(sender, e);
                }
            }
            catch (Exception ex)
        ...
        protected void gvShow_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            isUpdated = objPack.UpdatePack(txtName.Text, Convert.ToInt32(lblID.Text));
            if (isUpdated == 1)
            {
                // DataTable UserLog = (DataTable)Session["User"];

                lblMessage.Text = "Pack Updated Successfully";
                lblMessage.ForeColor = System.Drawing.Color.Green;
                //gvShow.EditIndex = -1;
                //  getAllCategoryGrid();
                Response.Redirect("PackMaster.aspx");
