<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="BrandMaster.aspx.cs" Inherits="OrthoSquare.Master.BrandMaster" %>
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">Brand</span>
                        </div>
                       <%-- <div class="actions">
                            <div class="btn-group">
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">Brand</span>
                        </div>
                       ...
                       <div class="text-right mb-20">
                        ...
                        <div class="table-scrollable">
                            ...
                            <asp:GridView ID="gvShow" runat="server" class="table table-bordered table-hover"
                                    GridLines="None" DataKeyNames="BrandId" AutoGenerateColumns="false" OnRowUpdating="gvShow_RowUpdating"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="30%" HeaderText="Sr. No.">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("BrandId") %>' Visible="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-Width="60%" HeaderText="Brand Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblName" runat="server" Text='<%# Eval("BrandName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("BrandName") %>' class="form-control input-sm"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="lbtDelete" runat="server" CommandName="delete" ImageUrl="../Images/delete15x15.png"
                                                    CausesValidation="False" OnClientClick="return confirm('Are you sure you want to delete this Brand Name?');" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
