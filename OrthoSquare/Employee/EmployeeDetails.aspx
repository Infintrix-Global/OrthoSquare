                                    ...
                                    <asp:TabPanel ID="tabPersonal" class="tab-pane" HeaderText="Personal Information " runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Employee No.</label>
                                                              <asp:TextBox ID="txtEmpCode" class="form-control"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:DropDownList ID="ddlDesignation" class="form-control" runat="server">
                                                              ...
                                                              <asp:RequiredFieldValidator ID="RequiredFieldValidatorddlDesignation" InitialValue ="0"  runat ="server" ControlToValidate="ddlDesignation"
                                                    ...
                                                    <div class="col-md-4">
                                                         <div class="form-group">
                                                            ...
                                                            <asp:CalendarExtender ID="txtENqDate_CalendarExtender" runat="server" Enabled="True" OnClientDateSelectionChanged="checkDate"
                                                ...
                                                <div align="Right">
                                                    <asp:Button ID="BtnNextContact" runat="server" Text="Next" class="btn btn-info btn-sm" OnClick="BtnNextContact_Click"  />
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                           &nbsp;&nbsp;&nbsp; <i class=" icon-layers font-red"></i><span class="caption-subject font-red bold uppercase">Current Address </span>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                      <label for="form_control_1">
                                                                        Current Area<span class="required"></span>
                                                                    </label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                     <label for="form_control_1">
                                                                        Current Pin Code <span class="required"></span>
                                                                    </label>
                                                                    <asp:TextBox ID="txtPincode" class="form-control" MaxLength="6" placeholder="Enter Pin Code" 
                                                                        runat="server"></asp:TextBox>
                                                                   
                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidatorPincode" runat="server"
                                                           ...
                                                           &nbsp;&nbsp;&nbsp; <i class=" icon-layers font-red"></i><span class="caption-subject font-red bold uppercase">Permanent Address </span>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="form_control_1">
                                                                        Permanent Area<span class="required"></span>
                                                                    </label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="form_control_1">
                                                                        Permanent Pin Code <span class="required"></span>
                                                                    </label>
                                                                    <asp:TextBox ID="txtperPincode" class="form-control" MaxLength="6" placeholder="Enter Pin Code"
                                                                        runat="server"></asp:TextBox>
                                                                    
                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidatorperPincode" runat="server"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox ID="txtPerTelephoneNO" class="form-control" placeholder="Enter Telephone"
                                                                        runat="server"></asp:TextBox>
                                                                   
                                                                    <span class="help-block">
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidatorPerTelephoneNO" runat="server"
                                                          ...
                                                          &nbsp;&nbsp;&nbsp;  <i class=" icon-layers font-red"></i><span class="caption-subject font-red bold uppercase">Bank Details </span>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox ID="txtIFSC_Code" MaxLength="15" class="form-control" placeholder="Enter IFSC Code"
                                                                        runat="server"></asp:TextBox>
                                                           ...
                                                           &nbsp;&nbsp;&nbsp; <i class=" icon-layers font-red"></i><span class="caption-subject font-red bold uppercase">Other Details </span>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="help-block">
                                                                      <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidatorAadhaarcard" runat="server"
                                                                            ControlToValidate="txtAadhaarcard" SetFocusOnError="true" ErrorMessage="Please Enter Aadhaar card No."
                                                                            ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidatorAadhaarcard" runat="server"
                                                                            ErrorMessage="Enter valid Aadhar card No." ControlToValidate="txtAadhaarcard"
                                                                            ForeColor="Red" SetFocusOnError="True" ValidationExpression="\d+"></asp:RegularExpressionValidator>
                                                                    </span>
                                                                </div>
                                                            </div>
                        ...
                        <div class="form-actions text-center">
                            ...
                            <asp:Button ID="btBack" runat="server" Text="Cancel" Class="btn default" ClientIDMode="Static" 
                                CausesValidation="False" />
                                            ...
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="btnDocupload" EventName="Click" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                            </ContentTemplate>
                                  </asp:TabPanel>
