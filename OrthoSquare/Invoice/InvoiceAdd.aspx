...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <asp:GridView ID="gvInformation" runat="server" ShowFooter="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Unit">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtSeatings1" Width="80px" OnTextChanged="txtSeatings1_TextChanged" AutoPostBack="true" TextMode="Number" class="form-control" Text='<%# Eval("Unit")%>' runat="server"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Cost">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtCost1" Width="200px" TextMode="Number" OnTextChanged="txtCost1_TextChanged" AutoPostBack="true" CssClass="form-control" Text='<%# Eval("Cost")%>' runat="server"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Discount">
                                                <ItemTemplate>

                                                    <asp:TextBox ID="txtDiscount1" Width="200px" TextMode="Number" OnTextChanged="txtDiscount1_TextChanged" AutoPostBack="true" class="form-control" Text='<%# Eval("Discount")%>' runat="server"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <div class="ratingItemList">
        ...
        <label class="rating rating-2" for="rating-2-2"><i class="em em-disappointed"></i>
      ...
      <label class="rating rating-2" for="RadioButton1"><i class="em em-disappointed"></i><h6>Unsatisfactory</h6></label>--%>
        ...
        <label class="rating rating-3" for="rating-3-2"><i class="em em-expressionless"></i>
            <h6>Satisfactory </h6>
        </label>
        <input class="rating rating-4" id="rating-4-2" type="radio" value="4" name="rating" />
        <label class="rating rating-4" for="rating-4-2"><i class="em em-grinning"></i>
