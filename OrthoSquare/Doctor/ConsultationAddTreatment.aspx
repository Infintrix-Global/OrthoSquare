                            ...
                            <div class="row" style="margin-bottom: 10px;">
                                ...
                                <div class="col-md-3">
                                    <div class="form-body">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldddl_DocterDetils" runat="server" ControlToValidate="txtDocter" ValidationGroup="C"
                                            ...
                                            <div class="panel-body">
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
                                                            <div class="table-responsive">
                                                                ...
                                                                <asp:GridView ID="GridViewViewMedicines" runat="server" Width="50%" DataKeyNames="CNo,patientid" OnRowCommand="GridViewViewMedicines_RowCommand"
                                                                ...
                                                                <asp:GridView ID="GridMedicinesDetails" class="table table-bordered table-hover" ShowFooter="true" runat="server" OnRowDeleting="GridMedicinesDetails_RowDeleting"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Medicines" ItemStyle-Width="25%">
                                                                            <ItemTemplate>
                                                                                <asp:DropDownList ID="ddlMedicinesName" Visible="false" OnSelectedIndexChanged="ddlMedicinesName_SelectedIndexChanged" AutoPostBack="true" class="form-control" runat="server">
                                                                                </asp:DropDownList>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Strip" ItemStyle-Width="6%">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtStrip" class="form-control" OnTextChanged="txtStrip_TextChanged" AutoPostBack="true" MaxLength="2" Text='<%# Eval("Strip")%>' runat="server"></asp:TextBox>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                            ...
                                                            <div class="col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="form-body">
                                                                            <label>Total </label>
                                                                            <asp:TextBox ID="txtTotal" class="form-control" ReadOnly="true" placeholder="Total" Text="" runat="server"></asp:TextBox>
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="form-body">
                                                                            ...
                                                                            <asp:TextBox ID="txtpay" class="form-control" OnTextChanged="txtpay_TextChanged" AutoPostBack="true" placeholder="Pay Amount" Text="" runat="server"></asp:TextBox>
                                                ...
                                                <div class="row">
                                                    <div class="text-center" style="padding: 10px; margin: 0; background-color: #f5f5f5; border-top: 1px solid #e7ecf1">
                                                        ...
                                                        <asp:Button ID="btnMedicines" runat="server" ValidationGroup="C" Text="Submit" class="btn blue" ClientIDMode="Static" OnClick="btnMedicines_Click" />

                                                        <asp:Button ID="BtlMedicinesPrint" runat="server" ValidationGroup="C" Visible="false" Text="Submit" class="btn blue" ClientIDMode="Static" OnClick="BtlMedicinesPrint_Click" />
                                                            ...
                                                            <div class="notranslate">
                                                                ...
                                                                <div class="row" runat="server" visible="false" id="TreatmentSubmit">
                                                                    <div class="text-center" style="padding: 10px; margin: 0; background-color: #f5f5f5; border-top: 1px solid #e7ecf1">
                                                                        ...
                                                                        <asp:Button ID="btnUpdateTreatment" runat="server" Text="Submit" ValidationGroup="T" class="btn blue" ClientIDMode="Static" OnClick="btnUpdateTreatment_Clicklab" />
