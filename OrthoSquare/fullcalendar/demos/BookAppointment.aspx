                         ...
                         <%--<div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input ">
                                   <asp:Button ID="Button1" runat="server" Text="Search" class="blue-hoki" ClientIDMode="Static"
                                            OnClick="btSearch_Click" />
                                   ...
                                   <Columns>
                                        <asp:TemplateField >
                                              <ItemTemplate >
                                                  ...
                                                  <asp:Button ID="btnSelect" CausesValidation="false" runat="server" CommandArgument = '<%# Eval("patientid") %>' class="btn blue" Text="Select" />
                                              </ItemTemplate>
