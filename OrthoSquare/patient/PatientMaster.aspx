                        ...
                        <asp:TabContainer ID="TabContactPerson1" class="nav nav-tabs " runat="server" ActiveTabIndex="0">
                                    ...
                                    <div class="col-xs-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div align="Right">
                                                    <asp:Button ID="BtnNextContact" runat="server" Text="Next" class="btn btn-info btn-sm" OnClick="BtnNextContact_Click" CausesValidation="true" />
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-10">
                                                <div class="form-body">
                                                    <asp:CheckBox ID="CheckConsentStatement" Text="Consent Statement" runat="server" />
                                                </div>
						...
						<div class="table-scrollable">
							...
							<asp:GridView ID="gvShow" runat="server" AllowPaging="true" AutoGenerateColumns="false"
									...
									<Columns>
                                        ...
                                        <%--Dhaval--%>
                                                <asp:TemplateField HeaderText="Patient Status" ItemStyle-Width="18%">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="Delete" ItemStyle-Width="2%">
											<ItemTemplate>
                                                 <asp:ImageButton ID="btnview" CausesValidation="false" runat="server" Height="10px" Width ="20px" CommandArgument='<%# Eval("patientid") %>'
