<%@ Page Title="" Language="C#" MasterPageFile="~/OrthoSquare.Master" AutoEventWireup="true" CodeBehind="NewRegistrationPatient.aspx.cs" Inherits="OrthoSquare.patient.NewRegistrationPatient" %>
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">New Patient Report</span>
                                    </div>
                                                ...
                                                <asp:GridView ID="gvShow" runat="server" AllowPaging="true" AutoGenerateColumns="false" ShowFooter="true"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Patient No">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPatientNO" runat="server" Text='<%# Eval("PatientCode") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFolllowupdate" runat="server" Text='<%# Eval("RegistrationDate","{0:dd/MMM/yyyy}") %>'></asp:Label>
                                                            </ItemTemplate>
